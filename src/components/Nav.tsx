...
const Nav: FC = () => {
  ...
  return (
    <nav className="py-2 px-2 text-sm font-light text-gray-500 flex-none h-fit">
      <ul className="flex space-x-9 justify-between items-center flex-wrap">
        <li className="px-1">{activeTodos.length} items left</li>
        <li className="flex space-x-1 justify-between">
          <button
